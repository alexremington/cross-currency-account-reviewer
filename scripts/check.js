...
const required = ['README.md', 'public/index.html', 'public/app.js', 'public/styles.css', 'core/csv.js', 'core/scoring.js', 'core/recommended-master.js', 'core/export.js', 'docs/account-parity-matrix.md', 'scripts/build-calibration-sample.js', 'scripts/evaluate-calibration.js'];
